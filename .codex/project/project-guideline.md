...
- `product-framing-review` has the visible name Task and Product Framing Skill while retaining
  `product-framing-review` as its stable workflow/package identifier and installed path basename.
