...
describe("interactive prompts and output", () => {
  ...
  it("explains policy-disabled completion modes and rejects unavailable selection clearly", async () => {
    ...
    expect(output.info).toHaveBeenCalledWith("Auto-merge disabled by policy for SIGNIFICANT.");
    expect(output.info).toHaveBeenCalledWith("Immediate merge disabled by policy for SIGNIFICANT.");
  });
});
